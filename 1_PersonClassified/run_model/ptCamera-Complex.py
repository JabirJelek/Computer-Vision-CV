...
class AppConfig:
    ...
    # Model configuration
    model_path: Path = Path(r"C:\Farid\Dokumen\Object Detection\CV_model\bestSmallS.torchscript")
    ...
    # Alert configuration
    alert_sound_path: Path = Path(r"C:\Farid\Dokumen\Object Detection\usedAudio\level-up-07-383747.mp3")
