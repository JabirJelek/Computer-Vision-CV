...
class VideoFrameExtractor:
    def __init__(self, output_dir="frames/captured_frames", capture_interval=1.0,
...
def main():
    ...
    parser.add_argument("-o", "--output", default="frames/captured_frames", help="Output directory")
