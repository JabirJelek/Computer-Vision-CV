...
#model_path = Path(r"C:\Farid\Download\FDM-Download\Documents\CV_model\last_float32.tflite")
#model = YOLO(str(model_path), task='detect')

# Load tflite model
model = tf.lite.Interpreter(model_path=r"C:\Farid\Dokumen\Object Detection\CV_model\last_float32.tflite")
