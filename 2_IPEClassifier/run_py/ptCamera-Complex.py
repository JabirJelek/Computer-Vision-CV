...
class AppConfig:
    ...
    # Model configuration
    model_path: Path = Path(r"D:\RaihanFarid\Dokumen\Object Detection\CV_model\bestIPE-2.torchscript")
...
def main():
    ...
    config = AppConfig(
        model_path=Path(r"D:\RaihanFarid\Dokumen\Object Detection\CV_model\bestIPE-2.torchscript"),
