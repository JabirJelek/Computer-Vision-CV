...
if __name__ == '__main__':
    ...
    obama_image = face_recognition.load_image_file(r"D:\Raihan Farid\Editor\Visual C++\Repo\3_FaceRecog\obama.jpg")
    obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

    # Load a second sample picture and learn how to recognize it.
    biden_image = face_recognition.load_image_file(r"D:\Raihan Farid\Editor\Visual C++\Repo\3_FaceRecog\Biden.jpg")
